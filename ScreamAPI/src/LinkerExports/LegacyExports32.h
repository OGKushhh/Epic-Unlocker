...
// REMOVED: #pragma comment(linker, "/export:_EOS_Auth_AddNotifyLoginStatusChanged@12=EOSSDK-Win32-Shipping_o._EOS_Auth_AddNotifyLoginStatusChanged@12")  (intercepted by eos-impl/ wrapper)
